...
$webMvcFolder = Join-Path $slnFolder "src/Arq.PortalDemo.Web.Mvc"
$webPublicFolder = Join-Path $slnFolder "src/Arq.PortalDemo.Web.Public"
...
dotnet restore Arq.PortalDemo.Web.sln
