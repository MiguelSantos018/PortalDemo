...
using Arq.PortalDemo.Web.Startup.ExternalLoginInfoProviders;
...
namespace Arq.PortalDemo.Web.Startup
{
    ...
    public class PortalDemoWebHostModule : AbpModule
    {
        private readonly IWebHostEnvironment _env;
        private readonly IConfigurationRoot _appConfiguration;

        public PortalDemoWebHostModule(
        ...
        {
            IocManager.RegisterAssemblyByConvention(typeof(PortalDemoWebHostModule).GetAssembly());
        }
