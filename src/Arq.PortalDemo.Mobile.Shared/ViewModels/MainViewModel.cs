...
using Arq.PortalDemo.Authorization.Users.Profile.Dto;
using Arq.PortalDemo.Commands;
using Arq.PortalDemo.Core.Threading;
using Arq.PortalDemo.Models.NavigationMenu;
using Arq.PortalDemo.Services.Navigation;
using Arq.PortalDemo.ViewModels.Base;
using Plugin.Media;
...
using Arq.PortalDemo.Controls;
using Arq.PortalDemo.Dto;
using Arq.PortalDemo.Extensions;
using Arq.PortalDemo.Localization;
using Arq.PortalDemo.UI;
using Arq.PortalDemo.UI.Assets;
using Arq.PortalDemo.Views;
using DependencyResolver = Arq.PortalDemo.Core.Dependency.DependencyResolver;

namespace Arq.PortalDemo.ViewModels
{
    public class MainViewModel : XamarinViewModel
    {
        ...
        private const string ApplicationName = "PortalDemo";
