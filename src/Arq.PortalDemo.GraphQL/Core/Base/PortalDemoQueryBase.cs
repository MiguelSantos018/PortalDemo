...
namespace Arq.PortalDemo.Core.Base
{
    public abstract class PortalDemoQueryBase<TField,TResult> : ITransientDependency
    {
        ...
        protected PortalDemoQueryBase(string fieldName,
