...
using Arq.PortalDemo.Core.Base;
using Arq.PortalDemo.Core.Extensions;
using Arq.PortalDemo.Dto;
using Arq.PortalDemo.Types;

namespace Arq.PortalDemo.Queries
{
    public class OrganizationUnitQuery : PortalDemoQueryBase<ListGraphType<OrganizationUnitType>, List<OrganizationUnitDto>>
    {
