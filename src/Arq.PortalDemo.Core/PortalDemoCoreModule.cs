...
using Arq.PortalDemo.Authorization.Ldap;
...
using Arq.PortalDemo.DashboardCustomization.Definitions;
using Arq.PortalDemo.Debugging;
using Arq.PortalDemo.DynamicEntityProperties;
using Arq.PortalDemo.Features;
using Arq.PortalDemo.Friendships;
using Arq.PortalDemo.Friendships.Cache;
using Arq.PortalDemo.Localization;
using Arq.PortalDemo.MultiTenancy;
using Arq.PortalDemo.Net.Emailing;
using Arq.PortalDemo.Notifications;
using Arq.PortalDemo.WebHooks;
using Newtonsoft.Json;

namespace Arq.PortalDemo
{
    [DependsOn(
        typeof(PortalDemoCoreSharedModule),
        typeof(AbpZeroCoreModule),
        typeof(AbpZeroLdapModule),
        typeof(AbpAutoMapperModule),
        typeof(AbpAspNetZeroCoreModule),
        typeof(AbpMailKitModule))]
    public class PortalDemoCoreModule : AbpModule
    {
        public override void PreInitialize()
        {
            ...
            PortalDemoLocalizationConfigurer.Configure(Configuration.Localization);
            ...
            Configuration.MultiTenancy.IsEnabled = PortalDemoConsts.MultiTenancyEnabled;
            ...
            Configuration.ReplaceService<IMailKitSmtpBuilder, PortalDemoMailKitSmtpBuilder>(DependencyLifeStyle.Transient);
            ...
            Configuration.ReplaceService(typeof(IEmailSenderConfiguration), () =>
            {
                Configuration.IocManager.IocContainer.Register(
                    Component.For<IEmailSenderConfiguration, ISmtpEmailSenderConfiguration>()
                             .ImplementedBy<PortalDemoSmtpEmailSenderConfiguration>()
                             .LifestyleTransient()
                );
            });
        ...
        {
            IocManager.RegisterAssemblyByConvention(typeof(PortalDemoCoreModule).GetAssembly());
        }
