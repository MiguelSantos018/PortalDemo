...
namespace Arq.PortalDemo.Authentication.TwoFactor.Google
{
    public class GoogleAuthenticatorProvider : PortalDemoServiceBase, IUserTwoFactorTokenProvider<User>, ITransientDependency
    {
        ...
        public Task<string> GenerateAsync(string purpose, UserManager<User> userManager, User user)
        {
            ...
            var setupInfo = _googleTwoFactorAuthenticateService.GenerateSetupCode("Arq.PortalDemo", user.EmailAddress, user.GoogleAuthenticatorKey, 300, 300);
