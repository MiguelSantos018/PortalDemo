namespace Arq.PortalDemo.Authorization
{
    ...
    public static class AppPermissions
    {
        ...
        public const string Pages_Movies_Create = "Pages.Movies.Create";
        public const string Pages_Movies_Edit = "Pages.Movies.Edit";
        public const string Pages_Movies_Delete = "Pages.Movies.Delete";
