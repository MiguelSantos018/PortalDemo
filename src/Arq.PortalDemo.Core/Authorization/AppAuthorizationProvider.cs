...
namespace Arq.PortalDemo.Authorization
{
    ...
    public class AppAuthorizationProvider : AuthorizationProvider
    {
        ...
        public override void SetPermissions(IPermissionDefinitionContext context)
        {
            ...
            var movies = administration.CreateChildPermission(AppPermissions.Pages_Movies, L("Movies"));
            movies.CreateChildPermission(AppPermissions.Pages_Movies_Create, L("Create"));
            movies.CreateChildPermission(AppPermissions.Pages_Movies_Edit, L("Edit"));
            movies.CreateChildPermission(AppPermissions.Pages_Movies_Delete, L("Delete"));

            var categories = administration.CreateChildPermission(AppPermissions.Pages_Categories, L("Categories"));
            categories.CreateChildPermission(AppPermissions.Pages_Categories_Create, L("Create"));
            categories.CreateChildPermission(AppPermissions.Pages_Categories_Edit, L("Edit"));
            categories.CreateChildPermission(AppPermissions.Pages_Categories_Delete, L("Delete"));
        ...
        {
            return new LocalizableString(name, PortalDemoConsts.LocalizationSourceName);
        }
    }
}
