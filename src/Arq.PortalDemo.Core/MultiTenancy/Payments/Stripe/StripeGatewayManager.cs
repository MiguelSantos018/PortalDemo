...
{
    public class StripeGatewayManager : PortalDemoServiceBase,
        ...
        ITransientDependency
    {
        ...
        public static string ProductName = "PortalDemo";
        ...
        {
            return editionName + "_" + paymentPeriodType + "_" + PortalDemoConsts.Currency;
        }
