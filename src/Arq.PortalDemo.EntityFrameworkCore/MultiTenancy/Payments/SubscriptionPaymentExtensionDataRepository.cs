...
using Arq.PortalDemo.EntityFrameworkCore.Repositories;

namespace Arq.PortalDemo.MultiTenancy.Payments
{
    public class SubscriptionPaymentExtensionDataRepository : PortalDemoRepositoryBase<SubscriptionPaymentExtensionData, long>,
        ISubscriptionPaymentExtensionDataRepository
    {
        public SubscriptionPaymentExtensionDataRepository(IDbContextProvider<PortalDemoDbContext> dbContextProvider) : base(dbContextProvider)
        {
        }
