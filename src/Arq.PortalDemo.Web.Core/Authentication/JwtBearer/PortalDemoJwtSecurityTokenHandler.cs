...
namespace Arq.PortalDemo.Web.Authentication.JwtBearer
{
    public class PortalDemoJwtSecurityTokenHandler : ISecurityTokenValidator
    {
        private readonly JwtSecurityTokenHandler _tokenHandler;

        public PortalDemoJwtSecurityTokenHandler()
        {
