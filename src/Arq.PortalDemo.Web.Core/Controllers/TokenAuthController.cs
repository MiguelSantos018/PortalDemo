...
using Arq.PortalDemo.Authentication.TwoFactor;
...
using Arq.PortalDemo.Web.Authentication.JwtBearer;
using Arq.PortalDemo.Web.Authentication.TwoFactor;
using Arq.PortalDemo.Web.Models.TokenAuth;
...
namespace Arq.PortalDemo.Web.Controllers
{
    ...
    public class TokenAuthController : PortalDemoControllerBase
    {
