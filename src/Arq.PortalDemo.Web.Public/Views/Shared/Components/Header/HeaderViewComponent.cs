...
using Arq.PortalDemo.Web.Public.Startup;
using Arq.PortalDemo.Web.Session;

namespace Arq.PortalDemo.Web.Public.Views.Shared.Components.Header
{
    public class HeaderViewComponent : PortalDemoViewComponent
    {
