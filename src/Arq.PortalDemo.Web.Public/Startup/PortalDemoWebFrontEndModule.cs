...
namespace Arq.PortalDemo.Web.Public.Startup
{
    [DependsOn(
        typeof(PortalDemoWebCoreModule)
    )]
    public class PortalDemoWebFrontEndModule : AbpModule
    {
        private readonly IConfigurationRoot _appConfiguration;

        public PortalDemoWebFrontEndModule(IWebHostEnvironment env, PortalDemoEntityFrameworkCoreModule abpZeroTemplateEntityFrameworkCoreModule)
        {
        ...
        {
            IocManager.RegisterAssemblyByConvention(typeof(PortalDemoWebFrontEndModule).GetAssembly());
        }
    }
}
