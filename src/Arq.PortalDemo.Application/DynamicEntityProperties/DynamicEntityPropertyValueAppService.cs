...
using Arq.PortalDemo.DynamicEntityPropertyValues.Dto;
...
namespace Arq.PortalDemo.DynamicEntityProperties
{
    ...
    public class DynamicEntityPropertyValueAppService : PortalDemoAppServiceBase, IDynamicEntityPropertyValueAppService
    {
