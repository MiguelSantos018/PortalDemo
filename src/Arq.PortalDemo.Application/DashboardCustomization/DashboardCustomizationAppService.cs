...
namespace Arq.PortalDemo.DashboardCustomization
{
    [AbpAuthorize]
    public class DashboardCustomizationAppService : PortalDemoAppServiceBase, IDashboardCustomizationAppService
    {
