...
{
    public class SessionAppService : PortalDemoAppServiceBase, ISessionAppService
    {
            ...
            return await _unitOfWorkManager.WithUnitOfWorkAsync(async () =>
            {
                var output = new GetCurrentLoginInformationsOutput
                {
                    Application = new ApplicationInfoDto
                    {
                        ...
                        Currency = PortalDemoConsts.Currency,
                        CurrencySign = PortalDemoConsts.CurrencySign,
                        AllowTenantsToChangeEmailSettings = PortalDemoConsts.AllowTenantsToChangeEmailSettings,
