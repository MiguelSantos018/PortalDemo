...
using Arq.PortalDemo.DemoUiComponents.Dto;

namespace Arq.PortalDemo.DemoUiComponents
{
    [AbpAuthorize(AppPermissions.Pages_DemoUiComponents)]
    public class DemoUiComponentsAppService : PortalDemoAppServiceBase, IDemoUiComponentsAppService
    {
