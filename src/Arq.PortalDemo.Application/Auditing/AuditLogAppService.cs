...
using Arq.PortalDemo.Auditing.Exporting;
...
using EntityHistoryHelper = Arq.PortalDemo.EntityHistory.EntityHistoryHelper;

namespace Arq.PortalDemo.Auditing
{
    [DisableAuditing]
    [AbpAuthorize(AppPermissions.Pages_Administration_AuditLogs)]
    public class AuditLogAppService : PortalDemoAppServiceBase, IAuditLogAppService
    {
