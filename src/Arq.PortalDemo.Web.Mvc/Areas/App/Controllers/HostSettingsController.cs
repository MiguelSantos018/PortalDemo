...
using Arq.PortalDemo.Configuration.Host;
using Arq.PortalDemo.Editions;
using Arq.PortalDemo.Timing;
using Arq.PortalDemo.Timing.Dto;
using Arq.PortalDemo.Web.Areas.App.Models.HostSettings;
...
namespace Arq.PortalDemo.Web.Areas.App.Controllers
{
    ...
    public class HostSettingsController : PortalDemoControllerBase
    {
