...
using Arq.PortalDemo.Web.Areas.App.Models.Languages;
...
namespace Arq.PortalDemo.Web.Areas.App.Controllers
{
    ...
    public class LanguagesController : PortalDemoControllerBase
    {
            ...
            string filterText = "")
        {
            ...
            {
                sourceName = PortalDemoConsts.LocalizationSourceName;
            }
