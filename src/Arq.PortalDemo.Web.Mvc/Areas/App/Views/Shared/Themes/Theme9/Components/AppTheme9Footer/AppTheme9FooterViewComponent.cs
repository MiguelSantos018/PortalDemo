...
namespace Arq.PortalDemo.Web.Areas.App.Views.Shared.Themes.Theme9.Components.AppTheme9Footer
{
    public class AppTheme9FooterViewComponent : PortalDemoViewComponent
    {
