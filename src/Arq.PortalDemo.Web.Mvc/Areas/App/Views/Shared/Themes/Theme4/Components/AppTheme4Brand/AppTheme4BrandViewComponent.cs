...
namespace Arq.PortalDemo.Web.Areas.App.Views.Shared.Themes.Theme4.Components.AppTheme4Brand
{
    public class AppTheme4BrandViewComponent : PortalDemoViewComponent
    {
