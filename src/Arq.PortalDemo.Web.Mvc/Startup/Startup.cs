...
using Arq.PortalDemo.Identity;
using Arq.PortalDemo.Schemas;
using Arq.PortalDemo.Web.Chat.SignalR;
using Arq.PortalDemo.Web.Common;
using Arq.PortalDemo.Web.Resources;
using Swashbuckle.AspNetCore.Swagger;
using Arq.PortalDemo.Web.IdentityServer;
using Arq.PortalDemo.Web.Swagger;
using Stripe;
...
using Arq.PortalDemo.Web.HealthCheck;
using Owl.reCAPTCHA;
using HealthChecksUISettings = HealthChecks.UI.Configuration.Settings;
using Microsoft.AspNetCore.Server.Kestrel.Https;
using Microsoft.Extensions.DependencyInjection.Extensions;
using Arq.PortalDemo.Web.Extensions;
using SecurityStampValidatorCallback = Arq.PortalDemo.Identity.SecurityStampValidatorCallback;
...
namespace Arq.PortalDemo.Web.Startup
{
    public class Startup
    {
        ...
        public IServiceProvider ConfigureServices(IServiceCollection services)
        {
            ...
            return services.AddAbp<PortalDemoWebMvcModule>(options =>
            {
        ...
        public void Configure(IApplicationBuilder app, IWebHostEnvironment env, ILoggerFactory loggerFactory)
        {
            ...
            if (env.IsDevelopment())
            {
                ...
                app.UsePortalDemoForwardedHeaders();
            }
            else
            {
            ...
            if (WebConsts.SwaggerUiEnabled)
            {
                ...
                {
                    options.SwaggerEndpoint(_appConfiguration["App:SwaggerEndPoint"], "PortalDemo API V1");
                    options.IndexStream = () => Assembly.GetExecutingAssembly()
                        .GetManifestResourceStream("Arq.PortalDemo.Web.wwwroot.swagger.ui.index.html");
        ...
        private void ConfigureSwagger(IServiceCollection services)
        {
            services.AddSwaggerGen(options =>
            {
                ...
                var applicationXml = $"Arq.PortalDemo.Application.xml";
                var applicationXmlPath = Path.Combine(AppContext.BaseDirectory, applicationXml);
                options.IncludeXmlComments(applicationXmlPath);

                var webCoreXmlFile = $"Arq.PortalDemo.Web.Core.xml";
