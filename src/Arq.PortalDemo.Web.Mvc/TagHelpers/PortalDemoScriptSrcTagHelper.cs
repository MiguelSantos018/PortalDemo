...
namespace Arq.PortalDemo.Web.TagHelpers
{
    ...
    public class PortalDemoScriptSrcTagHelper : TagHelper
    {
        ...
        public PortalDemoScriptSrcTagHelper(IWebHostEnvironment hostingEnvironment,
