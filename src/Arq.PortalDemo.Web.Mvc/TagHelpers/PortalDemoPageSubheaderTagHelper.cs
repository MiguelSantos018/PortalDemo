...
using Arq.PortalDemo.UiCustomization.Dto;

namespace Arq.PortalDemo.Web.TagHelpers
{
    ...
    public class PortalDemoPageSubheaderTagHelper : TagHelper
    {
        ...
        public PortalDemoPageSubheaderTagHelper(IUiThemeCustomizerFactory uiThemeCustomizerFactory)
        {
