...
using Arq.PortalDemo.MultiTenancy.HostDashboard;
...
namespace Arq.PortalDemo.Tests.HostDashboard
{
    ...
    public class HostDashboardAppService_Tests : AppTestBase
    {
        ...
        private void CreatePaidPayment(PortalDemoDbContext context, SubscriptionPayment subscriptionPayment)
        {
